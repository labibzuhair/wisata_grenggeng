...
<head>
    ...
    <meta name="author" content="KKN Desa Grenggeng IAINU Kebumen & team">
    ...
    <link href="{{ asset('bootstrap/custom.css') }}" rel="stylesheet">

    <!-- Favicons -->
    <link rel="icon" href="{{ asset('images/logo.jpg') }}" sizes="32x32" type="image/png">

    <!-- Custom styles for this template -->
    <link href="{{ asset('bootstrap/navbar-top-fixed.css') }}" rel="stylesheet">
</head>
