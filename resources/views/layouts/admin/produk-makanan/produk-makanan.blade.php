...
@section('content')
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4">Produk Makanan</h1>
        <ol class="breadcrumb mb-4">
            <a class="btn btn-primary " href="{{ route('admin.produk.makanan.create') }}">
                    ...
                    <tbody>
                        @foreach ($produks as $produk)
                            <tr>
                                ...
                                <td>
                                    <!-- Tombol Edit -->
                                    <a href="{{ route('admin.produk.makanan.edit', $produk->id) }}"
                                        class="btn btn-sm btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>

                                    <!-- Tombol Hapus -->
                                    <form action="{{ route('admin.produk.makanan.hapus', $produk->id) }}" method="POST"
