                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card bg-dark text-white"
                        ...
                        <div class="card-body p-5 text-center">
                            <div class="">
                                <h2 class="fw-bold mb-2 text-uppercase">Ubah Password</h2>
                                <p class="text-white-50 mb-5">Ubah Password admin</p>
                                ...
                                <form method="POST" action="{{ route('admin.updatePassword') }}">
                                    ...
                                    <div class="form-outline form-white mb-4">
                                        ...
                                        <input type="password" id="current_password" class="form-control form-control-lg"
                                            name="current_password" required />
                                    </div>

                                    <div class="form-outline form-white mb-4">
                                        <label class="form-label" for="typePasswordX">Password Baru</label>
                                    ...
                                    <button class="btn btn-outline-light btn-lg px-5" type="submit">Ubah Password</button>
                                </form>
                            </div>
                        </div>
                    </div>
