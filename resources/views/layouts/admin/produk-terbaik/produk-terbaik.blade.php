...
@section('title', ' Semua Produk Terbaik')

@section('content')

    <div class="container-fluid px-4">
        <h1 class="mt-4">Produk Terbaik</h1>
        <ol class="breadcrumb mb-4">
            <a class="btn btn-primary " href="{{ route('admin.produk.terbaik.create') }}">
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                Data Produk Oleh-Oleh Maknan Ringan
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($produks as $produk)
                            <tr>
                                ...
                                <td>
                                    <!-- Tombol Edit -->
                                    <a href="{{ route('admin.produk.terbaik.edit', $produk->id) }}"
                                        class="btn btn-sm btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>

                                    <!-- Tombol Hapus -->
                                    <form action="{{ route('admin.produk.terbaik.hapus', $produk->id) }}" method="POST"
