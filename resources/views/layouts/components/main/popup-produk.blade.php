                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="card text-black">
                                ...
                                <!-- Gambar-gambar kecil di bawahnya -->
                                <div class="thumbnail-images d-flex justify-content-center">
                                    <!-- Gambar-gambar kecil akan dimasukkan secara dinamis di sini -->
                                </div>
                                <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">
                                                <div class="d-flex justify-content-between">
                                                    <span><b>Kategori : </b></span><span id="productCategory"></span>
                                                </div>
                                            </li>
                                            <li class="list-group-item">
                                ...
                                <div class="card-body justify-content-center">
                                    <div class="d-flex justify-content-center align-items-center pb-2 mb-1">
                                        <a class="btn btn-primary" id="buyNowLink" aria-disabled="true" role="button"
                                            target="_blank">Tanyakan Produk</a>
                                    </div>
                                </div>
                            </div>
                        </div>
