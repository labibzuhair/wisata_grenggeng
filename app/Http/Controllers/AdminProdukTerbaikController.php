...
class AdminProdukTerbaikController extends Controller
{
    /**
    ...
    {
        return view('layouts.admin.produk-terbaik.create');
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('admin.produk.terbaik.create')->with('success', 'Produk berhasil disimpan!');
        } catch (\Exception $e) {
            // Menangkap error dan mengembalikan pesan error
            return redirect()->route('admin.produk.terbaik.create')->with('error', 'Terjadi kesalahan: ' . $e->getMessage())->withInput();
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('layouts.admin.produk-terbaik.edit', compact('produk'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            if (!$produk) {
                return redirect()->route('admin.produk.terbaik.edit', $id)
            ...
            return redirect()->route('admin.produk.terbaik')->with('success', 'Produk berhasil diperbarui!');
        } catch (\Exception $e) {
            return redirect()->route('admin.produk.terbaik.edit', $id)
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.produk.terbaik')->with('success', 'Produk berhasil dihapus.');
    }
}
